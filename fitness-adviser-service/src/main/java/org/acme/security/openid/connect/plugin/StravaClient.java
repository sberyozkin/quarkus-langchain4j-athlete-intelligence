...
public interface StravaClient {
    ...
    record DetailedAthlete(long id, String firstname, String lastname, String city, String state,
            String country, Double weight, List<SummaryGear> bikes, List<SummaryGear> shoes) {
    }
    ...
    record AthleteStats(double biggest_ride_distance, double biggest_climb_elevation_gain, 
        ...
        record ActivityTotal(int count, float distance, int moving_time, int elapsed_time, float elevation_gain, int achievement_count) {
        }
    }
    ...
    record Lap(long id, MetaActivity activity, MetaAthlete athlete,
            float averafe_cadence, float averafe_speed, float distance, int elapsed_time,
            int start_index, int end_index, int lap_index, float max_speed, int moving_time,
            String name, int pace_zone, int split,
            LocalDateTime start_date_local, float total_elevation_gain) {
    ...
    record Route(SummaryAthlete athlete, String description, float distance, float elevation_game, long id,
        ...
        record SummarySegment(long id, String name, ActivityType activity_type, float distance,
                float average_grade, float maximum_grade, float elevation_high, float elevation_low, int climb_category,
                String city, String state, String country,
                SummaryPRSegmentEffort athlete_pr_effort, SummarySegmentEffort athlete_segment_stats) {
        }
        ...
        record SummaryPRSegmentEffort(long pr_activity_id, int pr_elapsed_time, LocalDateTime pr_date, int effort_count) {
        }
